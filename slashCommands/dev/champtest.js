...
module.exports = {
  name: "champtest", //the command name for the Slash Command
  description: "Summon champ and test it", //the command description for Slash Command Overview
  cooldown: 1,
  ...
  run: async (client, interaction) => {
    try{
        ...
        function getRandomChamp() {
            request('http://ddragon.leagueoflegends.com/cdn/12.8.1/data/en_US/champion.json', function (error, response, body) {
